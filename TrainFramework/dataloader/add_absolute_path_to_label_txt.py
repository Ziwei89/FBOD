...
if __name__ == '__main__':
    train_img_label_txt_file_all = "img_label_" + num_to_chinese_c_dic[continuous_img_num] + "_continuous_all_raw.txt"
    list_file = open(train_img_label_txt_file_all, 'w')

    train_img_label_txt_file = "img_label_" + num_to_chinese_c_dic[continuous_img_num] + "_continuous_train_raw.txt"
    ...
    val_img_label_txt_file = "img_label_" + num_to_chinese_c_dic[continuous_img_num] + "_continuous_test_raw.txt"
