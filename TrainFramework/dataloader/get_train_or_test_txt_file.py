...
if __name__ == '__main__':
    train_img_label_txt_file = cross_vx_path + "img_label_" + num_to_chinese_c_dic[continuous_img_num] + "_continuous_train_raw.txt"
    train_list_file = open(train_img_label_txt_file, 'w')
    test_img_label_txt_file = cross_vx_path + "img_label_" + num_to_chinese_c_dic[continuous_img_num] + "_continuous_test_raw.txt"
    test_list_file = open(test_img_label_txt_file, 'w')

    img_label_five_continuous_all_raw_file = "img_label_" + num_to_chinese_c_dic[continuous_img_num] + "_continuous_all_raw.txt"
    ...
    with open(img_label_five_continuous_all_raw_file) as f:
        lines = f.readlines()
        for line in lines:
