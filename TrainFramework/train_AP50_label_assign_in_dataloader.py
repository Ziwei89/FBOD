...
if __name__ == "__main__":
    ...
    train_data = CustomDataset(train_lines, (model_input_size[1], model_input_size[0]), image_path=train_dataset_image_path,
                               input_mode=opt.input_mode, continues_num=opt.input_img_num, assign_method=opt.assign_method, data_augmentation=opt.data_augmentation)
    ...
    val_data = CustomDataset(val_lines, (model_input_size[1], model_input_size[0]), image_path=val_dataset_image_path,
                             input_mode=opt.input_mode, continues_num=opt.input_img_num, assign_method=opt.assign_method, data_augmentation=False)
